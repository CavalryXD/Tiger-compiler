...
public class Ast {
    ...
    public static class Exp {
        ...
        public static class Call extends T {
          ...
          public java.util.LinkedList<Type.T> at; // arg's type Elaborator中设置
          public Type.T rt;   // 返回值类型 Elaborator中设置
    ...
    public static class Method {
        ...
        public static class MethodSingle extends T {
            ...
            public Exp.T retExp;        // 单独的返回的表达式, 区别于别的语句
