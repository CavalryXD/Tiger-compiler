...
public class Tiger
{
  ...
  public void compile(String fname)
  {
    ...
    //       "Pretty printing AST", ast.Fac.prog1, pp);
    //   // ppPass.doit();
    ...
    //       "Elaborating the AST", ast.Fac.prog1, elab);
    //   elabPass.doit();
      
    //   // optimize the AST
    //   ast.optimizations.Main optAstPasses = new ast.optimizations.Main();
    //   control.CompilerPass optAstPass = new control.CompilerPass(
    //       "Optimizing AST", optAstPasses, ast.Fac.prog1);
    //   optAstPass.doit();
    //   ast.Fac.prog1 = (ast.Ast.Program.T) optAstPasses.program;
    ...
    //       "Translation to C code", ast.Fac.prog1, transC);
    //   genCCodePass.doit();
    ...
    //         "Bytecode generation", ast.Fac.prog1, trans);
    ...
    //         "Dalvik code generation", ast.Fac.prog1, transDalvik);
    ...
    // optAstPass.doitName("doit");     // 超级大BUG
    optAstPass.doit();
    ...
    // System.out.println("CodeGen finished !");
