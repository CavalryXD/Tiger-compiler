...
public class Ast
{
  ...
  public static class Type
  {
    ...
    // 这个在C语言的AST中不再代表对象类型, 而是代表对classType的struct指针
  ...
  public static class Exp
  {
    ...
    {
      public String assign;   // 调用函数的(classType的struct指针)的id
      public T exp;           // 表示调用者id或者 new id () --> (struct Doit*)(Tiger_new())
      public String id;       // 函数名
      public LinkedList<T> args;  // 由于TypeChecking在此前就已经成功所以不需要Type了
  ...
  public static class Class
  {
    ...
    {
      // 现在的ClassSingle相当于C语言中的结构体, 只有声明的变量了
      public String id;
  ...
  public static class Method
  {
    ...
    {
      public Type.T retType;
      public String classId;    // ??? 属于哪一个类的方法?
      public String id;
