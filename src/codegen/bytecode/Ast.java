...
public class Ast
{
  ...
  public static class Stm
  {
   ...
   //jump if one integer is less than another
    ...
    // static方法的局部变量表中以第0号变量位第一个形参, 而非static方法则是从1开始
    // 方法调用结束后, 会返回调用者的栈帧, 并将返回值置于栈顶
    /*----------------------
     * Before    |  After   |
     * ---------------------
     * arg1      | result   |
    ...
    // JVM中的new是指创建一个Object类的对象, 并将其引用压入栈顶
